...
//TODO:write for these classes interfaces and beans and delete the dependencies in pom!!
...
public class FITeagleServlet extends XmlRpcServlet {
	...
	public void doPost(final HttpServletRequest req,
		...
		System.out.println("doPost is called. Processing the request! ");
		System.out.println("!!!!!!!!!!!!!!!!!!test call on fiteagle with v3 ok!!!!!!!!!!!!!!!!!!!!!!!");
  ...
  private X509Certificate getCert(HttpServletRequest req) throws IOException {
    ...
    System.out.println("getCert is called, checking the client certificate! ");
    if (null != certs && certs.length > 0) {
        return certs[0];
    }
    //TODO: fix this. this must throw an exception
    return null;
