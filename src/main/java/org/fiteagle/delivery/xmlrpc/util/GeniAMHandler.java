...
import org.fiteagle.sfa.ISFA;
import org.fiteagle.sfa.SFAInteractor_v3;
...
import org.fiteagle.sfa.common.GeniAvailableOption;
import org.fiteagle.sfa.common.GeniBestEffortOption;
import org.fiteagle.sfa.common.GeniEndTimeoption;
import org.fiteagle.sfa.common.GeniUser;
import org.fiteagle.sfa.common.GeniUserList;
...
//  }
  ...
  private Object parseListResourcesOptions(Object from, Object to) {
    ...
    if(listResourceOptionsStruct.get("geni_compressed")!=null){
      listResourceOptions.setGeni_compressed(new org.fiteagle.sfa.common.GeniCompressedOption(
          listResourceOptionsStruct.getBoolean("geni_compressed")));
    }else {
      listResourceOptions.setGeni_compressed(new org.fiteagle.sfa.common.GeniCompressedOption(false));
    }
